    ...
    <div class=" pt-16 grid grid-flow-col justify-around ...">
        <div>
            ...
            <div class="">
                ...
                <button wire:click="AddSaldo" id="apropria"
            ...
            <div class=" lg:flex lg:flex-wrap">
                @foreach ($faturas as $fatura)
                    <div class="max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow white:bg-gray-800 white:border-gray-700 lg:w-1/1">
                        ...
                        <button class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 white:bg-blue-600 white:hover:bg-blue-700 white:focus:ring-blue-800">
                            Pagar
